...
<div class="header">
    <div style="display: flex; align-items: center; flex-direction: column; padding-left:5px; padding-right: 5px;">
        <img id="logo" src="${logoBase64}" alt="Logo" height="50" width="50" />
        <div style="display: flex; flex-direction: column; align-items: center;">
            <p style="margin:0; font-size: 14px; font-weight: bold; text-align: center"> Zavod za transfuziju <br/> krvi crne gore</p>
        </div>
    </div>
    <div class="title">KARTON DAVAOCA</div>
    <div>Datum: ________________________________________________</div>
</div>
